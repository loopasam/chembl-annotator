...
public class CurationTest extends UnitTest {
	...
	public void removeAnnotation() {
		...
		Annotation annotation = Annotation.find("byAssay", assay1).first();
	...
	public void addFakeAnnotation() {
		...
		Annotation dummy = Annotation.find("isFake", true).first();
		
		assertEquals(true, assay2.annotations.contains(dummy));
	}
